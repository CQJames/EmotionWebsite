				...
				<div class="main-wrap">
					...
					<div class="user-safety">
						...
						<div class="user-infoPic">
							...
							<div class="filePic">
								<input type="file" class="inputPic" accept="image/*">
								<img class="am-circle am-img-thumbnail" src="${pageContext.request.contextPath}<s:property value="#session.user.icon"/>" alt="" />
							</div>
							...
							<ul>
								<li>
									...
									<div class="m-left">
										...
										<div class="fore2"><small>为保证您账号安全，建议您定期更改密码以保护账号安全。</small></div>
									</div>
									<div class="fore3">
										<div class="am-btn am-btn-secondary"><a href="${pageContext.request.contextPath}/person_password.jsp">修改</a></div>
									</div>
								</li>
								<li>
									...
									<div class="m-left">
										...
										<div class="fore2"><small>您验证的邮箱为：<s:property value="#session.user.email"/> 可用于快速找回登录密码</small></div>
									</div>
									<div class="fore3">									
										<div class="am-btn am-btn-secondary"><a href="${pageContext.request.contextPath}/person_email.jsp">换绑</a></div>
									</div>
								</li>
							</ul>
						</div>
