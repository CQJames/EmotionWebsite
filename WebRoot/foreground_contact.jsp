				...
				<div class="wrap">
					<div class="contact">
						<div class="cont span_2_of_contact">
							<h5 class="leave" style="margin-left: 330px;">向我们发送您的意见</h5>
							<div class="clear"></div>
							<form method="post" action="${pageContext.request.contextPath}/ContactAction_commitOpinion">
								<div class="contact-to">
									<input type="text" class="text" name="name" value="<s:property value='#request.name'/>" placeholder="您的姓名...">
									<input type="text" class="text" name="email" value="<s:property value='#request.email'/>" placeholder="您的邮箱..." style="margin-left: 10px">
									<input type="text" class="text" name="subject" value="<s:property value='#request.subject'/>" placeholder="主题...">
								</div>
								<div class="text2">
									<textarea name="message" placeholder="信息..."><s:property value='#request.message'/></textarea>
								</div>
								<div class="btnSubmit">
							    	<input id="btnSubmit" class="submit" type="submit" value="发送">
								</div>
							</form>
						</div>
						<div class="lsidebar span_1_of_about">
							<h5 class="leave" style="margin-left: 83px">其它方式联系我们</h5>
							<div class="clear"></div>
							<div class="contact-list">
								<ul>
									<li><img src="${pageContext.request.contextPath}/foreground/images/address.png" alt="地址" />
										<p>地址：广东省肇庆市端州区黄岗街道肇庆学院<br>工作室：紫薇苑13栋111宿舍</p>
										<div class="clear"></div>
									</li>
									<li><img src="${pageContext.request.contextPath}/foreground/images/phone.png" alt="电话" />
										<p>电话: 13621446560<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;13202783297</p>
										<div class="clear"></div>
									</li>
									<li><img src="${pageContext.request.contextPath}/foreground/images/msg.png" alt="邮箱" />
										<p>邮箱: <span class="red"><a href="https://mail.qq.com/" target="_blank">1625186043@qq.com</a></span></p>
										<div class="clear"></div>
									</li>
								</ul>
							</div>
