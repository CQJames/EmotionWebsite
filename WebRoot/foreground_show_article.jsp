...
<html>
	...
	<head>
		...
		<script src="${pageContext.request.contextPath}/foreground/js/joke.js" type="text/javascript"></script>
	...
	<body>
		...
		<div class="main">
			<div class="portfolio-top">
				<div class="wrap">
					<h5><s:property value="joke.title"/></h5>
				</div>
			</div>
			<div class="container_left">
				<ul id="publisher_and_time" class="clearfix position">
					<li><span>作者：<s:property value="joke.publisher"/></span></li>
					<li><span><s:date format="yyyy-MM-dd hh:mm:ss" name="joke.changeTime"/></span></li>
				</ul>
			</div>
			<div class="container_left">
				<ul id="remark" class="clearfix position">
					<li><span>摘要：<s:property value="joke.remark"/></span></li>
				</ul>
			</div>
			<div class="container_message">
				<ul id="message" class="clearfix position">
				    <li id = "messageHiden"  hidden="hidden">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;正文：<s:property value="joke.message"/></li>
					<li id = "messageShow"></li>
				</ul>
			</div>
			<div class="container_right">
				<ul id="clicks" class="clearfix position">
					<li id="likes" class="likes"><p class="img"><img src="${pageContext.request.contextPath}/foreground/images/likes.png" title="点赞" alt="点赞" /><a id="like" data-id="<s:property value="joke.jokeID"/>"><s:property value="joke.clicks"/></a></p></li>
				</ul>
			</div>
			<div class="container_right">
				<input id="JokeCollection" type="button" class="button11" style="margin-left: 41.5%;background:#ffea00;color:black;" onclick="JokeCollection()" value="点击收藏笑话">
				<input type="hidden" id="User_ID" value="<s:property value="#session.user.userID"/>"/>
				<input type="hidden" id="Joke_ID" value="<s:property value="joke.jokeID"/>">
			</div>
		</div>
		<div class="footer">
