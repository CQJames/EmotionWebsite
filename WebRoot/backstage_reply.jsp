...
<html>
  <head>
		...
		<script charset="utf-8" src="${pageContext.request.contextPath}/backstage/common/kindeditor/config.js"></script>
   	    ...
   	    <script type="text/javascript" src="${pageContext.request.contextPath}/backstage/js/reply.js"></script>

	</head>
  <body>
	    <table id="dg"></table>
	    <div id="reply-toolbar" style="padding:5px;height:30px">
			...
			<div style=" text-align: right; float: right;">		
				<input id="reply-message" class="easyui-textbox" data-options="prompt: '回复内容查找'" style="width: 150px"></input>
