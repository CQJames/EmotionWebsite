...
<html>
	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/person/css/stepstyle.css" rel="stylesheet" type="text/css">

		<script type="text/javascript" src="${pageContext.request.contextPath}/person/js/jquery-1.7.2.min.js"></script>
		<script src="${pageContext.request.contextPath}/person/AmazeUI-2.4.2/assets/js/amazeui.js"></script>
		<!--
        	作者：843990246@qq.com
        	时间：2018-11-26
        	描述：添加的css和js
		...
		<script src="${pageContext.request.contextPath}/person/js/password.js" type="text/javascript"></script>
		<script>
		...
		<div class="center">
			<div class="col-main">
				<div class="main-wrap">
					...
					<div class="m-progress">
						<div class="m-progress-list">
							...
							<span class="step-2 step">
                                <em class="u-progress-stage-bg"></em>
                                <i class="u-stage-icon-inner">2<em id="flag" class="bg"></em></i>
					...
					<form id="form" onsubmit="return myCheck()" class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/UserForegroundAction_modifyUserPassword" method="post">
						<div class="am-form-group">
							<label for="user-old-password" class="am-form-label">原密码</label>
							<div class="am-form-content">
								<input type="password" id="user-old-password" class="password_input" name="password" placeholder="请输入原登录密码" value="<s:property value="#request.user.password"/>">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-new-password" class="am-form-label">新密码</label>
							<div class="am-form-content">
								<input type="password" id="user-new-password" class="password_input" name="newPassword" placeholder="支持数字，字母及字符，长度6-20" value="<s:property value="#request.newPassword"/>">
							</div>
						</div>
						<div class="am-form-group">
							<label for="user-confirm-password" class="am-form-label">确认密码</label>
							<div class="am-form-content">
								<input type="password" id="user-confirm-password" class="password_input" name="repassword" placeholder="请再次输入上面的密码" value="<s:property value="#request.repassword"/>">
							</div>
						</div>
						<div id="errorMessage"><s:property value="exception.message"/></div>
				    	<div id="errorMessageShow" class="errorMessageHidden">111</div>
						<div class="info-btn">
							<div class="am-btn am-btn-danger">
							    <input id="btnSubmit" class="btnSubmit" type="submit" value="保存修改">
							</div>
						</div>
                        <div id="success" class="passwordSuccess"><s:property value="#request.success"/></div>
					</form>
				...
				<aside class="menu">
					<ul>
						...
						<li class="person">
							<a href="${pageContext.request.contextPath}/person_collection.jsp">我的小窝</a>
							<ul>
								<li>
