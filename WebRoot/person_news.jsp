...
<html>
	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/person/css/newstyle.css" rel="stylesheet" type="text/css">

		<script src="${pageContext.request.contextPath}/person/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
					...
					<div class="user-news">
						...
						<div class="am-tabs am-tabs-d2" data-am-tabs>
							<ul class="am-avg-sm-3 am-tabs-nav am-nav am-nav-tabs">
								<li class="am-active"><a href="#tab1">对方回复</a></li>
							</ul>
								...
								<div class="am-tab-panel am-fade am-in am-active" id="tab1">
									<div class="news-day">
										...
										<div class="s-msg-item s-msg-temp i-msg-downup">
											<h6 class="s-msg-bar"><span class="s-name">您好啊！</span></h6>
												...
												<div class="i-msg-downup-con">
													<a class="i-markRead" target="_blank" href="blog.html">
														...
														<p class="s-row s-main-content">
															<a href="blog.html">
															查看完整回复 <i class="am-icon-angle-right"></i>
															</a>
														</p>
													</a>
												</div>
