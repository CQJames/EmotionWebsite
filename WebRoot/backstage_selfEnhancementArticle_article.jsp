...
<html>
  <head>
		...
		<script charset="utf-8" src="${pageContext.request.contextPath}/backstage/common/kindeditor/config.js"></script>
   	    ...
   	    <script type="text/javascript" src="${pageContext.request.contextPath}/backstage/js/selfEnhancementArticle_article.js"></script>

	</head>
  <body>
	    <table id="dg"></table>
	    <div id="article-toolbar" style="padding:5px;height:30px">
			<div style="margin-bottom:5px; float: left;">
				<a href="javascript:void(0)" onClick="$('#dg').datagrid('reload');" class="easyui-linkbutton" data-options="iconCls:'icon-reload'">刷新</a>
				<a href="javascript:void(0)" onClick="$('#winAdd').window('open');" class="easyui-linkbutton" data-options="iconCls:'icon-add'">添加文章</a>
			</div>
			<div style=" text-align: right; float: right;">
				<input id="article-title" class="easyui-textbox" data-options="prompt: '输入文章标题'" style="width: 150px"></input>
		    		...
		    		<tr>
		    			...
		    			<td>
		    				<select class="easyui-combobox" name="category" data-options="editable:false,panelHeight:'100'" style="width: 500px">
		    					<option value="认识自我">认识自我</option>
		    					<option value="自身建设">自身建设</option>
		    				</select>
		    			</td>
		    		</tr>
		    		<tr>
		...
		<div id="winUpdate" class="easyui-window" title="修改用户" data-options="iconCls:'icon-save',modal:true,closed:true,draggable:false,resizable:false,fit:true">
			...
			<form id="formUpdate" method="post">
				<input type="hidden" name="selfEnhancementArticleID" maxLength=50/>
