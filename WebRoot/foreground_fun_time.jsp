	...
	<body>
		...
		<div class="main">
			<div class="portfolio-top">
				<div class="wrap">
					<h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;那天那位女生跟我说：“今天好冷啊！”</h5>
					<h5>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;我看了看一下自己，然后得意的对她说：“还好今天多穿了件衣服。”</h5>
					<h3>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;她：“。。。”</h3>
				</div>
			</div>
			<div class="container">
				<ul id="filters" class="clearfix">
					<li><span class="filter active" data-filter="亲情 友情 爱情">全部</span></li>
					<li><span class="filter" data-filter="亲情">亲情</span></li>
					<li><span class="filter" data-filter="友情">友情</span></li>
					<li><span class="filter" data-filter="爱情">爱情</span></li>
				</ul>
				<div class="clear"></div>
				<div id="portfoliolist">
					<div class="wrapper">
					    <!-- 遍历文章简要集合 -->
					    <s:iterator value="#request.jokeList">
						    <div class="portfolio <s:property value="category"/> mix_all" data-cat="<s:property value="category"/>">
							    <div class="portfolio-wrapper">
								    <div class="jokeimgbox">
									    <a href="${pageContext.request.contextPath}/JokeAction_findJokeById?jokeID=<s:property value="jokeID"/>" target="_blank">
										    <img src="${pageContext.request.contextPath}<s:property value="image"/>" alt="<s:property value="title"/>">
									    </a>
								    </div>
								    <div class="links">
								        <h4><a href="${pageContext.request.contextPath}/JokeAction_findJokeById?jokeID=<s:property value="jokeID"/>" target="_blank"><span><s:property value="title"/></span></a></h4>
									    <p class="img"><img src="${pageContext.request.contextPath}/foreground/images/likes.png" title="点赞" alt="点赞" /><s:property value="clicks"/></p>
									    <div class="clear"></div>
									    <ul>
										    <li>
											    <a href="${pageContext.request.contextPath}/JokeAction_findJokeById?jokeID=<s:property value="jokeID"/>"  target="_blank"><span><s:date format="yyyy-MM-dd hh:mm:ss" name="changeTime"/></span></a>
										    </li>
									    </ul>
								    </div>
							    </div>
