...
<html>
  <head>
		...
		<script charset="utf-8" src="${pageContext.request.contextPath}/backstage/common/kindeditor/config.js"></script>
   	    ...
   	    <script type="text/javascript" src="${pageContext.request.contextPath}/backstage/js/communicationSkillsArticle_comment.js"></script>

	</head>
  <body>
	    <table id="dg"></table>
	    <div id="comment-toolbar" style="padding:5px;height:30px">
			...
			<div style=" text-align: right; float: right;">		
				<input id="comment-message" class="easyui-textbox" data-options="prompt: '评论内容查找'" style="width: 150px"></input>
