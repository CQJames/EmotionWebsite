...
<html>
  <head>
		...
		<script charset="utf-8" src="${pageContext.request.contextPath}/backstage/common/kindeditor/config.js"></script>
   	    ...
   	    <script type="text/javascript" src="${pageContext.request.contextPath}/backstage/js/contact.js"></script>

	</head>
  <body>
	    <table id="dg"></table>
	    <div id="contact-toolbar" style="padding:5px;height:30px">
			...
			<div style=" text-align: right; float: right;">
				<input id="contact-title" class="easyui-textbox" data-options="prompt: '输入姓名查询'" style="width: 150px"></input>
