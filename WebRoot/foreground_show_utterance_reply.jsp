...
<html>
	...
	<head>
		...
		<script src="${pageContext.request.contextPath}/foreground/js/reply-page-init.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/foreground/js/reply.js" type="text/javascript"></script>
	...
	<body>
		...
		<div class="main">
		    ...
		    <div id="utterancePublisher" class="noshow"><s:property value="utterance.publisher"/></div>
		    <div id="utterance" class="clearfix position commentBigBox utterance">
				...
				<div>
					...
					<span class="commentTime" style='margin-top:0px;'><s:date format="yyyy-MM-dd hh:mm:ss" name="utterance.saveTime"/></span>
				</div>
			    <div>
					<span class="commentMessage"><s:property value="utterance.message"/></span>
				</div>
				<div id="utteranceReply" class="tree-hole-replay noshow" style="float: right;cursor: pointer;color: blue;"><label for="commentMessage"><a id="utteranceReplyA">回复</a></label></div>		
			  </div>
		    </div>
		    <div class="container_right">
				<input id="UtteranceCollection" type="button" class="button11" style="margin-left: 41.5%;background:#ffea00;color:black;" onclick="UtteranceCollection()" value="点击收藏话语">
				<input type="hidden" id="User_ID" value="<s:property value="#session.user.userID"/>"/>
				<input type="hidden" id="Utterance_ID" value="<s:property value="utterance.utteranceID"/>">
			</div>
			<div id="commentSum" class="reply_title">相互的回复(<s:property value="#request.replyPage.totalCount"/>)</div>
			<div id="utteranceID" class="noshow"><s:property value="utterance.utteranceID"/></div>
			<div class="container_left" style="padding-left:  14%;">
			  <!-- 当前页码 -->
			  <div id="currPage" class="noshow"><s:property value="#request.replyPage.currPage"/></div>
			  <!-- 每页显示记录数 -->
			  <div id="pageSize" class="noshow"><s:property value="#request.replyPage.pageSize"/></div>
		      <!-- 总记录数 -->
		      <div id="totalCount" class="noshow"><s:property value="#request.replyPage.totalCount"/></div>
		      <!-- 总页数 -->
		      <div id="totalPage" class="noshow"><s:property value="#request.replyPage.totalPage"/></div>
			  <div id="pageData0" class="clearfix position commentBigBox pagingHidden">
				...
				<div id="replyBox0" class="tree-hole-replay noshow" style="float: right;cursor: pointer;color: blue;"><label for="commentMessage"><a>回复</a></label></div>		
			  </div>
			  <div id="pageData1" class="clearfix position commentBigBox pagingHidden">
				...
				<div id="replyBox1" class="tree-hole-replay noshow" style="float: right;cursor: pointer;color: blue;"><label for="commentMessage"><a>回复</a></label></div>		
			  </div>
			  <div id="pageData2" class="clearfix position commentBigBox pagingHidden">
				...
				<div id="replyBox2" class="tree-hole-replay noshow" style="float: right;cursor: pointer;color: blue;"><label for="commentMessage"><a>回复</a></label></div>		
			  </div>
			  <div id="pageData3" class="clearfix position commentBigBox pagingHidden">
				...
				<div id="replyBox3" class="tree-hole-replay noshow" style="float: right;cursor: pointer;color: blue;"><label for="commentMessage"><a>回复</a></label></div>		
			  </div>
			  <div id="pageData4" class="clearfix position commentBigBox pagingHidden">
				...
				<div id="replyBox4" class="tree-hole-replay noshow" style="float: right;cursor: pointer;color: blue;"><label for="commentMessage"><a>回复</a></label></div>		
			  </div>
			  <div id="pageData5" class="clearfix position commentBigBox pagingHidden">
				...
				<div id="replyBox5" class="tree-hole-replay noshow" style="float: right;cursor: pointer;color: blue;"><label for="commentMessage"><a>回复</a></label></div>		
			  </div>
			  <div style="margin-left: 250px;width: 90%;" class="pagger-box pagger" id="box"></div>
			</div>
			<a id="afterLogin" href="${pageContext.request.contextPath}/foreground_login.jsp"><button class="button11">登录/注册后回复</button></a>
			<div id="leaveComment" class="leaveComment noshow">
	    		<h5 class="comment">欢迎留下您给对方的回复</h5>
				<div class="clear"></div>
				<div class="text2">
					<textarea id="commentMessage" name="message" placeholder="回复..."></textarea>
				</div>
				<div class="btnSubmit">
