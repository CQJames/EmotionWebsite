...
<html>
	...
	<head>
		...
		<script src="${pageContext.request.contextPath}/foreground/js/self-enhancement-article.js" type="text/javascript"></script>
		...
		<script src="${pageContext.request.contextPath}/foreground/js/self-enhancement-comment-page-init.js" type="text/javascript"></script>
		<script src="${pageContext.request.contextPath}/foreground/js/self-enhancement-comment.js" type="text/javascript"></script>
	...
	<body>
		...
		<div class="main">
			<div class="portfolio-top">
				<div class="wrap">
					<h5><s:property value="selfEnhancementArticle.title"/></h5>
				</div>
			</div>
			<div class="container_left">
				<ul id="publisher_and_time" class="clearfix position">
					<li><span>作者：<s:property value="selfEnhancementArticle.publisher"/></span></li>
					<li><span><s:date format="yyyy-MM-dd hh:mm:ss" name="selfEnhancementArticle.changeTime"/></span></li>
				</ul>
			</div>
			<div class="container_left">
				<ul id="remark" class="clearfix position">
					<li><span>摘要：<s:property value="selfEnhancementArticle.remark"/></span></li>
				</ul>
			</div>
			<div class="container_message">
				<ul id="message" class="clearfix position">
					<li id = "messageHiden"  hidden="hidden">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;正文：<s:property value="selfEnhancementArticle.message"/></li>
					<li id = "messageShow"></li>
				</ul>
			</div>
			<div class="container_right">
				<ul id="clicks" class="clearfix position">
					<li id="likes" class="likes"><p class="img"><img src="${pageContext.request.contextPath}/foreground/images/likes.png" title="点赞" alt="点赞" /><a id="like" data-id="<s:property value="selfEnhancementArticle.selfEnhancementArticleID"/>"><s:property value="selfEnhancementArticle.clicks"/></a></p></li>
				</ul>
			</div>
			<div class="container_right">
				<input id="SeCollection" type="button" class="button11" style="margin-left: 41.5%;background:#ffea00;color:black;" onclick="SeCollection()" value="点击收藏文章">
				<input type="hidden" id="User_ID" value="<s:property value="#session.user.userID"/>"/>
				<input type="hidden" id="Se_ID" value="<s:property value="selfEnhancementArticle.selfEnhancementArticleID"/>">
			</div>
			<div id="selfEnhancementArticleID" class="noshow"><s:property value="selfEnhancementArticle.selfEnhancementArticleID"/></div>
			...
			<div id="commentSum" class="comment_title">留言(<s:property value="#request.selfEnhancementCommentPage.totalCount"/>)</div>
			<div class="container_left" style="padding-left:  14%;">
			  <!-- 当前页码 -->
			  <div id="currPage" class="noshow"><s:property value="#request.selfEnhancementCommentPage.currPage"/></div>
			  <!-- 每页显示记录数 -->
			  <div id="pageSize" class="noshow"><s:property value="#request.selfEnhancementCommentPage.pageSize"/></div>
		      <!-- 总记录数 -->
		      <div id="totalCount" class="noshow"><s:property value="#request.selfEnhancementCommentPage.totalCount"/></div>
		      <!-- 总页数 -->
		      <div id="totalPage" class="noshow"><s:property value="#request.selfEnhancementCommentPage.totalPage"/></div>
			  ...
			  <div style="margin-left: 310px;width: 80%;" class="pagger-box pagger" id="box"></div>
			</div>
		</div>
		<div class="footer">
