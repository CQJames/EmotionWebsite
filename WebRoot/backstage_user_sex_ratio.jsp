...
<html>
	...
	<head>
		...
		<script charset="utf-8" src="${pageContext.request.contextPath}/backstage/common/kindeditor/config.js"></script>
   	    ...
   	    <script type="text/javascript" src="${pageContext.request.contextPath}/backstage/js/sex-ratio.js"></script>
	</head>

	<body>
		<div id="sex-ratio" class="easyui-panel" title="" style="width:1260px;height:520px;padding:10px;">
		</div>
	</body>
