...
<html>
	...
	<head>
        ...
        <script src="${pageContext.request.contextPath}/foreground/js/communication-skills-page-init.js"></script>
		<script>
	...
	<body>
		...
		<div class="main">
			<div class="project-wrapper">
				<div class="project">
				    <div class="blog-bg">
			        	<h4>"每一份心动，<br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;都值得行动！"</h4><span class="author">------&nbsp;cyy</span>
		    	    	<div class="clear"></div>
		        	</div>
		        	<!-- 当前页码 -->
				    <div id="currPage" class="noshow"><s:property value="#request.communicationSkillsArticlePage.currPage"/></div>
				    <!-- 每页显示记录数 -->
				    <div id="pageSize" class="noshow"><s:property value="#request.communicationSkillsArticlePage.pageSize"/></div>
				    <!-- 总记录数 -->
				    <div id="totalCount" class="noshow"><s:property value="#request.communicationSkillsArticlePage.totalCount"/></div>
				    <!-- 总页数 -->
				    <div id="totalPage" class="noshow"><s:property value="#request.communicationSkillsArticlePage.totalPage"/></div>
					<div class="blog-left">
						<div id="pageData0" class="blog-img pagingHidden">
								<img src="" alt="" />
								<div class="blog-desc">
									<h5><a href="" target="_blank"></a></h5>
									<p><a href="" target="_blank"></a></p>
									<div class="comment">
										<span class="icon"><img style="width:55%;" src="${pageContext.request.contextPath}/foreground/images/b-heart.png" title="likes" alt="点赞"/><span></span></span>
						...
						<div id="pageData1" class="blog-img1 pagingHidden">
							    <img src="" alt="" />
								<div class="blog-desc">
									<h5><a href="" target="_blank"></a></h5>
									<p><a href="" target="_blank"></a></p>
						...
						<div id="pageData2" class="blog-img2 pagingHidden">
								<img src="" alt="" />
								<div class="blog-desc">
									<h5><a href="" target="_blank"></a></h5>
									<p><a href="" target="_blank"></a></p>
					...
					<div class="blog-right">
						<div id="pageData3" class="blog-img pagingHidden">
								<img src="" alt="" />
								<div class="blog-desc">
									<h5><a href="" target="_blank"></a></h5>
									<p><a href="" target="_blank"></a></p>
						...
						<div id="pageData4" class="blog-img1 pagingHidden">
								<img src="" alt="" />
								<div class="blog-desc">
									<h5><a href="" target="_blank"></a></h5>
									<p><a href="" target="_blank"></a></p>
						...
						<div id="pageData5" class="blog-img2 pagingHidden">
								<img src="" alt="" />
								<div class="blog-desc">
									<h5><a href="" target="_blank"></a></h5>
									<p><a href="" target="_blank"></a></p>
				...
				<div class="project-sidebar">
					...
					<div class="project-list">
						<h4>精选文章</h4>
						<ul class="blog-list">
					    	<s:iterator value="#request.communicationSkillsArticleCList1">
							<li><img src="${pageContext.request.contextPath}/foreground/images/arrow.png" alt="">
								<p>
									<a href="${pageContext.request.contextPath}/CommunicationSkillsArticleAction_findById?communicationSkillsArticleID=<s:property value="communicationSkillsArticleID"/>" target="_blank"><s:property value="title"/></a>
								</p>
								<div class="clear"></div>
							</li>
							</s:iterator>
						...
						<ul class="blog-list">
							<s:iterator value="#request.communicationSkillsArticleCList2">
							<li><img src="${pageContext.request.contextPath}/foreground/images/arrow.png" alt="">
								<p>
									<a href="${pageContext.request.contextPath}/CommunicationSkillsArticleAction_findById?communicationSkillsArticleID=<s:property value="communicationSkillsArticleID"/>" target="_blank"><s:property value="title"/></a>
								</p>
					...
					<div class="project-list">
						<h4>最新文章</h4>
						<ul class="blog-list">
							<s:iterator value="#request.communicationSkillsArticleNList1">
							<li><img src="${pageContext.request.contextPath}/foreground/images/arrow.png" alt="">
								<p>
									<a href="${pageContext.request.contextPath}/CommunicationSkillsArticleAction_findById?communicationSkillsArticleID=<s:property value="communicationSkillsArticleID"/>" target="_blank"><s:property value="title"/></a>
								</p>
						...
						<ul class="blog-list">
							<s:iterator value="#request.communicationSkillsArticleNList2">
							<li><img src="${pageContext.request.contextPath}/foreground/images/arrow.png" alt="">
								<p>
									<a href="${pageContext.request.contextPath}/CommunicationSkillsArticleAction_findById?communicationSkillsArticleID=<s:property value="communicationSkillsArticleID"/>" target="_blank"><s:property value="title"/></a>
								</p>
					...
					<div class="project-list">
						<h4>热门文章</h4>
						<ul class="blog-list">
							<s:iterator value="#request.communicationSkillsArticlePList1">
							<li><img src="${pageContext.request.contextPath}/foreground/images/arrow.png" alt="">
								<p>
									<a href="${pageContext.request.contextPath}/CommunicationSkillsArticleAction_findById?communicationSkillsArticleID=<s:property value="communicationSkillsArticleID"/>" target="_blank"><s:property value="title"/></a>
								</p>
						...
						<ul class="blog-list">
							<s:iterator value="#request.communicationSkillsArticlePList2">
							<li><img src="${pageContext.request.contextPath}/foreground/images/arrow.png" alt="">
								<p>
									<a href="${pageContext.request.contextPath}/CommunicationSkillsArticleAction_findById?communicationSkillsArticleID=<s:property value="communicationSkillsArticleID"/>" target="_blank"><s:property value="title"/></a>
								</p>
