...
<html>
	...
	<head>
		...
		<script src="${pageContext.request.contextPath}/person/js/email.js" type="text/javascript"></script>
		<script>
		...
		<div class="center">
			<div class="col-main">
				<div class="main-wrap">
					...
					<form id="form" onsubmit="return myCheck()" class="am-form am-form-horizontal" action="${pageContext.request.contextPath}/UserForegroundAction_modifyUserEmail" method="post">
						<div class="am-form-group centerShow">
							<label for="user-email" class="am-form-label">验证邮箱</label>
							<div class="am-form-content">
								<input type="email" id="user-email" style="width: 300px;" class="EmailHeight" placeholder="请输入邮箱地址" name="email" value="<s:property value="#session.user.email"/>">
							</div>
						</div>
						<div class="am-form-group code centerShow">
							<label for="user-code" class="am-form-label">验证码</label>
							<div class="am-form-content checkCodeEmail">
								<input type="text" id="user-code" style="width: 300px;margin-right:-70px;margin-left: -70px;" class="checkCodeEmailHeight" name="checkCode" placeholder="验证码">
							</div>
