...
public class IOFactory {
    ...
    public static StringBuilder read(String filePath, String fileName, String charset) {
        ...
        try {
            String fullPath = combainPath(filePath, fileName);
            File file = new File(fullPath);
            sb.append(IOFactory.tail(file, false, 0, charset));
        } catch (Exception ex) {
            j2log(null, null, ex);
        }
        return sb;
    ...
    public static StringBuilder find(String filePath, String fileName, int line, String charset) {
        ...
        try {
            String fullPath = combainPath(filePath, fileName);
            File file = new File(fullPath);
            sb.append(IOFactory.tail(file, true, line, charset));
        } catch (Exception ex) {
            j2log(null, null, ex);
        }
        return sb;
    ...
    public static StringBuilder tail(String filePath, String fileName, boolean find, int line, String charset) {
        ...
        try {
            String fullPath = combainPath(filePath, fileName);
            File file = new File(fullPath);
            sb.append(IOFactory.tail(file, find, line, charset));
        } catch (Exception ex) {
            j2log(null, null, ex);
        }
        return sb;
    ...
    public static List<String> sed(String filePath, String fileName, String charset) {
        ...
        try {
            String fullPath = combainPath(filePath, fileName);
            File file = new File(fullPath);
            list.addAll(IOFactory.sed(file, charset));
        } catch (Exception ex) {
            j2log(null, null, ex);
        }
        return list;
    ...
    public static void dd(String filePath, String fileName, byte[] content, boolean isAppend) {
        try {
            String fullPath = combainPath(filePath, fileName);
            File file = new File(fullPath);
            IOFactory.dd(file, content, isAppend);
        } catch (Exception ex) {
            j2log(null, null, ex);
        }
    }
    ...
    public static void write(String filePath, String fileName, String content) {
        try {
            String fullPath = combainPath(filePath, fileName);
            File file = new File(fullPath);
            IOFactory.write(file, content, true);
        } catch (Exception ex) {
            j2log(null, null, ex);
        }
    }
    ...
    public static void write(String filePath, String fileName, String content, boolean isAppend) {
        try {
            String fullPath = combainPath(filePath, fileName);
            File file = new File(fullPath);
            IOFactory.write(file, content, isAppend);
        } catch (Exception ex) {
            j2log(null, null, ex);
        }
    }
    ...
    public static void tail(String filePath, String fileName, String content, long index) {
        try {
            String fullPath = combainPath(filePath, fileName);
            File file = new File(fullPath);
            IOFactory.tail(file, content, index);
        } catch (Exception ex) {
            j2log(null, null, ex);
        }
    }
    ...
    /**
     * convert InputStream TO OutputStream TO String
     *
     * @param in 
     * @return String
     */
