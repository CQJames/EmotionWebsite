...
public class JavaMailFactory {
	 ...
	 * @param loginAccount 登录邮箱的账号:如 "1625186043@qq.com"
	...
	public static int sendEmail(String mailServer,final String loginAccount,final String loginAuthCode,String sender,String[] recipients,
		...
		try {
            ...
            //2收件人:可以多个
            //一个的收件人
            //msg.setRecipient(RecipientType.TO, new InternetAddress("843990246@qq.com"));
	...
	public static int sendMyEmail(String[] recipients,String emailSubject,String emailContent){
		int res = JavaMailFactory.sendEmail("smtp.qq.com", "1625186043@qq.com", "djniwnrnxdpqdiah", "1625186043@qq.com", recipients, emailSubject, emailContent, "text/html;charset=utf-8");
		return res;
	}
	
    public static void main(String[] args) throws Exception {
    	
    	int res=sendEmail("smtp.qq.com", "1625186043@qq.com", "djniwnrnxdpqdiah", "1625186043@qq.com", new String[]{
    			"843990246@qq.com" //这里就是一系列的收件人的邮箱了
    	}, "黄俊健", "祝你早日脱单,请我吃脱单饭!","text/html;charset=utf-8");
